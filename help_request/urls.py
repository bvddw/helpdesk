...
urlpatterns = [
    ...
    path('requests-to-check/', views.CheckRequestsView.as_view(), name='request_to_check_view'),
    path('requests-for-restoration/', views.RestorationRequestsView.as_view(), name='requests_for_restoration_view'),
